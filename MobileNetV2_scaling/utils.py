...
def get_network(args):
    ...
    if args.net == 'mobilenetv2':
        from models.MobileNetV2_scale import mobilenetv2
        net = mobilenetv2(args.d,args.w)
    else:
...
def get_training_dataloader(args,mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    transform_train = transforms.Compose([
        ...
        transforms.Resize(int(32*args.r)),
        transforms.RandomCrop(int(32*args.r), padding=int(4*args.r)),
